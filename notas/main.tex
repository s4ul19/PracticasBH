...
fact that a hamiltonian might only have 2 symmetric sectors. It is remarkable that applying both a sector averanging and a time window averangin proves to be the most precise approach.
\begin{figure}[H]
    \centering
