...
value of the GOE becomes indistinguishable from the Poisson prediction, therefore, it motivates to think that, above certain k, there is 
...
\textit{The following two figures show the behavior of $\ev{r^{k}_n}$ for small k of several BH realizations for differnt J/U ranging from 0.05 to 1 and the Poisson and GOE characteristic curves.}
\begin{figure}[H]
\centering
