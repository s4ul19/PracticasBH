...
\end{equation}
Esta cantidad permite observar la universalidad de RMT en los espectros de energía\snote{Listo.}\janote{no modificaste este enunciado. Toca quitar la primera parte, porque discutimos ayer que no es cierto}.
...
\snote{Listo.}\janote{mirá cómo hice para que los paréntesis se vean bien. Cambialo así en la siguiente ecuación}
...
y para la distribución de Poisson \janote{la distribución de Poisson*} un valor de $\ev{r}_{Poisson}=0.38629$~\cite{Atas_2013}. 
...
\begin{itemize}
    \item Tarea 1: Estudiar sobre de las simetrías en un Hamiltoniano y su forma diagonal por bloques de simetría\snote{Listo.}\janote{su forma diagonal por bloques debido a la simetría*}.
    \item Tarea 2: Estudiar sobre el modelo de Bose Hubbard
    \snote{Listo.}\janote{Agregá una tarea de estudiar sobre el modelo de Bose-Hubbard}
    ...
    \item Tarea 10: Escribir el informe final.\snote{Listo.}\janote{Mejor cambiá esto por escribir el informe final}
\end{itemize}
\input{cronograma}
