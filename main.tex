...
Denotando por $E_n$ las energía ordenadas del espectro del hamiltoniano, y
    ...
    Se espera que este valor medio sea un indicador de caos, ya que para el ensabamble GOE, dicho valor es de $\ev{r}=0.5307$\janote{Corregir}~\cite{Atas_2013}.
...
\end{itemize}
Se espera que $\ev{r}$\janote{corregir} y la divergencia ($KL$\janote{revisar}) estén relacionadas, pues ambas son indicadores de caos cuántico. 
