...
\janote{Ahora que las correcciones fueron menores, me sirve
...
En un contexto de física clásica \snote{Listo.}\janote{física clásica**, creo que es más preciso}, el caos presenta dos características de importancia. 
La primera es una sensibilidad exponencial a las condiciones iniciales y la segunda es el "mixing", cualquier distribución inicial de condiciones iniciales se dispersa hasta volverse indistinguible de la distribución de equilibrio. \snote{Listo.}\janote{me gusta ya la información. Ahora sólo quiero que corrijás 
...
algo así. El objetivo es que sea más fácil de leer}. En un contexto de física cuántica\snote{Listo.}\janote{física cuántica**}, en vista del principio de incertidumbre, no es posible tener 
...
ello motivo en parte a el uso de RMT para la descripción del hamiltoniano de este tipo de sistemas. \snote{Listo.}\janote{del Hamiltoniano
...
se han hecho realizaciones experimentales con átomos ultrafríos sobre un red óptica y se ha podido observar la transición SF-MI (Superfluidez-Aislante de Mott\snote{Considero que esa es una buena traducción.}\janote{mejor en español})~\cite{Zhang2010}. 
...
\end{equation}
\snote{Listo.}\janote{Ojo con que $J$ y $U$ en el texto deben estar dentro de \$\$, revisá
...
\snote{Sección trasaldada a donde está $\ev{r}$ }\janote{Esto integralo en el bullet point de la $\ev{r}$}
