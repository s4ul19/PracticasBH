...
es la fuerza de interacción entre bosones en mismo sitio~\cite{Zhang2010}\janote{Hice modificaciones a estos dos últimos enunciados (era sólo uno antes). Comparalo con cómo lo tenías antes para entender los cambios y si te parece bien, sólo quitá este comentario}. 
...
Denotando por $E_n$ las energía ordenadas del espectro del hamiltoniano, y el espaciamiento consecutivo de niveles de energía como 
    ...
    Es importante tener presente la forma análitica de la distribución de los cocientes entre los espaciamientos de niveles del ensabamble GOE, el cual es de la forma~\cite{Atas_2013}\janote{ojo que ambas distribuciones de 
...
mostrar que el valor esperado son los numeritos tales.. }
...
\subsection{Objetivo general}
 ...
 \textbf{NEW ver.}
  \begin{itemize}
    ...
    \item Estudiar acerca del mean level spacing ratio $\ev{r}$ y la divergencia $KL$, asi acerca de la distribuciones de \janote{los cocientes de} espaciamientos de valores propios de los ensambles de matrices aleatorias, en particular, el ensamble GOE.
...
en sistemas de muchos cuerpos que no tienen contraparte clásica\janote{este enunciado partilo en dos, haciendo las modificaciones necesrias}. Este trabajo es un ejemplo de ello, ya que se estará trabajando con 
